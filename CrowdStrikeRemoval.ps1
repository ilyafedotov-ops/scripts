...
foreach ($vmName in $vmList) {
 ...
 $snapshotConfig = New-AzSnapshotConfig -Location $vm.Location -SourceUri $https://lnkd.in/e6PT6Swf -CreateOption Copy
 ...
 # Get the OS disk
 $disk = Get-AzDisk -ResourceGroupName $resourceGroupName -DiskName $https://lnkd.in/eRU54Pe3
